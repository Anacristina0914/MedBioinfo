...
#srun --cpus-per-task=1 --time=00:30:00 singularity exec /proj/applied_bioinformatics/users/x_anago/images/appbio.sif xargs -I{} -a /proj/applied_bioinformatics/users/x_anago/MedBioinfo/analyses/x_anago_run_accessions.txt fastqc {}_1.fastq.gz {}_2.fastq.gz -t 1
